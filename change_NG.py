# -*- coding: utf-8 -*-
"""
Created on Fri Mar  1 10:43:01 2019
...
#read the hourly price to figure out what generator is responsible for the price
hourly_price=pd.read_excel('sim_hourly_prices.xlsx',header=0)

Gas_price=pd.read_csv('Synthetic_daily_natural_gas.csv')
a=random.randint(0,1000)
Gas_price=Gas_price.values[a*365:a*365+365]

New_price_NG(hourly_price,Gas_price)
